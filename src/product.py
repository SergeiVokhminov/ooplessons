...
if __name__ == "__main__":
    ...
    prod4 = Product("Газонная трава", "Элитная трава для газона", 500.0, 20)
    ...
    print()
    prod5 = Product.new_product({"name": '43" FullHD', "description": "Смарт ТВ", "price": 43000.0, "quantity": 5})
    print(prod5.name)
    print(prod5.description)
    print(prod5.price)
    print(prod5.quantity)
    prod6 = Product.new_product(
        {"name": "Iphone 15", "description": "512GB, Gray space", "price": 210000.0, "quantity": 2},
    )
    print(prod6.quantity)
